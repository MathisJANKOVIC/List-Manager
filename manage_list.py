        ...
        while(operation_to_perform_index != OPERATION_OPTIONS.index("Return")):
            ...
            if(operation_to_perform_index == 0): # add new element
                ...
                if(len(selected_list.content) > 0):
                    ...
                    sure_to_rm = None
                    element_to_rm = 0
                    while(sure_to_rm != 0 and element_to_rm != -1): # while the user doesn't cancel the operation or doesn't select an element to remove
                        ...
                        if(element_to_rm != rm_options.index(CONFIRM_OPTIONS[1])):
                ...
                main(lists, selected_option_index)
    else:
        return
